...
class AdminDAO:
    ...
    @classmethod
    async def block_user(cls, user_id: int, session: AsyncSession):
    ...
    @classmethod
    async def unblock_user(cls, user_id: int, session: AsyncSession):
        query = select(User).where(
            User.id == user_id,
            User.is_active == False,
        )
    ...
    @classmethod
    async def delete_project(cls, project_id: int, session: AsyncSession):
