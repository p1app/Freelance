...
class ProjectService:
    ...
    async def create_project(
        ...
        if data.deadline <= datetime.now():  # noqa: DTZ005
    ...
    async def update_project(
        ...
        updated_project = await ProjectDAO.update(
    ...
    async def publish_project(
        ...
        published_project = await ProjectDAO.publish(
    ...
    async def cancel_project(
        ...
        cancelled_project = await ProjectDAO.cancel(
            session=session, project_id=project_id
        )
    ...
    async def assign_freelancer(
        ...
        updated_project = await ProjectDAO.assign_freelancer(
    ...
    async def list_projects(
        ...
        if current_user is None:
            projects, total = await ProjectDAO.get_open_projects(
    ...
    async def get_my_projects(
        ...
        projects, total = await ProjectDAO.get_by_customer(
    ...
    async def get_working_projects(
        ...
        projects, total = await ProjectDAO.get_by_freelancer(
            session=session,
