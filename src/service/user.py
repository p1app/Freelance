...
class UserService:
    ...
    @classmethod
    async def get_public_profile(cls, session: AsyncSession, user_id: int) -> UserPublicResponse:
    ...
    @classmethod
    async def get_stats(cls, session: AsyncSession, current_user: User) -> UserStatsResponse:
        ...
        return UserStatsResponse(
            ...
            completed_count=total_projects_freelance,
    ...
    async def get_freelancers(
        ...
        valid_freelancers = [
            UserPublicResponse.model_validate(freelancer)
